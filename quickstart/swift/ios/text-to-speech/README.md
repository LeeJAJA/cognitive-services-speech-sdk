# Quickstart: Synthesize audio in Swift on iOS using the Speech SDK

This sample demonstrates how to create an iOS app in Swift using the Cognitive Services Speech SDK to synthesize audio from text input.
