...
* A PC (Windows x64, Ubuntu 16.04 or 18.04 on x64 or ARM64) or Mac (macOS 10.13 or later) capable to run Eclipse,[<sup>[1]</sup>](#footnote1) with a working microphone.
